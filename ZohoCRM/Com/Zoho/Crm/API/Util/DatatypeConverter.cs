...
namespace Com.Zoho.Crm.API.Util
{
    ...
    public class DataTypeConverter<T>
    {
        ...
        static readonly PreConverter preCommonTypeConverter = (obj) => { return (T) Convert.ChangeType(obj, typeof(T)); };

        static readonly PostConverter postCommonTypeConverter = (obj) => { return (T) Convert.ChangeType(obj, typeof(T)); };
        ...
        private static void Init()
        {
            ...
            AddToDictionary(typeof(object).FullName,
                (obj) => { return (T) PreConvertObjectData(obj); },
                (obj) => { return PostConvertObjectData(obj); });

            AddToDictionary(typeof(string).FullName,
                (obj) => { return (T) Convert.ChangeType(Convert.ToString(obj), typeof(T)); },
                (obj) => { return Convert.ToString(obj); });
